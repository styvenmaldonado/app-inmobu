    ...
    <div class="flex flex-col gap-6 px-5 pt-32 h-full">
      <section class="flex flex-col gap-8">
        ...
        <div>
          ...
          <h2 class="text-xl leading-6">Basado en la información proporcionada, hemos determinado que en este momento tu solicitud no se alinea con todos los requisitos necesarios para continuar con el proceso.</h2>
          <h2 class="text-xl leading-6">Agradecemos tu comprensión. Te invitamos a visitar nuestra página principal para conocer más sobre nuestros servicios.</h2>
        </div>
